...
describe('TicketsService', () => {
  ...
  describe('create', () => {
    it('should create a new ticket', async () => {
      ...
      delete mockTicketDto['eventId'];
      delete mockTicketDto['userId'];
      expect(result).toEqual({...mockTicketDto, event: mockEvent, user: mockUser});
  ...
  describe('findAllTicketsForUser', () => {
    it('should return all tickets for a user', async () => {
      ...
      const mockTickets = [mockTicket] as Ticket[];
